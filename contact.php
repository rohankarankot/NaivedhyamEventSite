...
<body >
 ...
 <div class="container row m-auto text-center">
   ...
   <div class="col-md-6 col-sm-6 ">
     <h3 class="text-white">By Call</h3><a href="tel:7558310113" data-toggle="modal" data-target="#modelcall">
     <img src="img/call.png" id="callimg"><br>
     Click here to contact...</a><hr>
   </div>
   <div class="col-md-6 col-sm-6 "  >
    <h3 class="text-white">By Whatsapp</h3><a href="tel:7558310113" data-toggle="modal" data-target="#modelwhatsapp">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="container row  text-center">
          ...
          <div class="col-md-6">
            <a href="//api.whatsapp.com/send?phone=917558310113&text=Hey... regarding an Event..." style="color: black;">
